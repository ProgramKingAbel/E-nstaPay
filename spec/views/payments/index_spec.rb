...
describe "Payments", type: :system do
  ...
  it "Allows User to view the list Payments per Category" do
    ...
    payment1 = Payment.create(name: "Payment 1", amount: 10.50, user: user, groups: [group1])
    payment2 = Payment.create(name: "Payment 2", amount: 15.75, user: user, groups: [group1])
    payment3 = Payment.create(name: "Payment 3", amount: 5.25, user: user, groups: [group1])
